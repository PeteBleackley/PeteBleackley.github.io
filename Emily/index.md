...
To ensure that Emily will perform well at scale, I have implemented the sparse indices with [Polars](https://docs.pola.rs/), which allows for lazy evaluation and distributed computation. Asynchronous code is used wherever possible.
